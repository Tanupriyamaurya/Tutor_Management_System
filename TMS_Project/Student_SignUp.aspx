    ...
    <div style="max-width:1300px; width:100%; margin:auto; padding:30px; background:#fff; border-radius:12px; box-shadow:0px 5px 20px rgba(0,0,0,0.3);">
        ...
        <div class="row mx-0 px-3">
            ...
            <div class="col-md-4">
                ...
                <asp:TextBox ID="FatherNameTextBox" CssClass="form-control mb-3" placeholder="Enter Father Name" runat="server" />
...
<asp:RequiredFieldValidator 
    ...
    runat="server">
                ...
                <asp:TextBox ID="StandardTextBox" CssClass="form-control mb-3" placeholder="Enter Standard" runat="server" />
                                <asp:RequiredFieldValidator ControlToValidate="StandardTextBox" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator9" runat="server" ErrorMessage="Standard is Required"></asp:RequiredFieldValidator>

                <asp:DropDownList ID="GoingToDropDownList" CssClass="form-control mb-3" runat="server">
                   ...
                   <asp:RequiredFieldValidator  InitialValue="Select Going To" ControlToValidate="GoingToDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator10" runat="server" ErrorMessage="Select Going To is Required"></asp:RequiredFieldValidator>

                <asp:TextBox ID="SubjectTextBox" CssClass="form-control mb-3" placeholder="Enter Subject" runat="server" />
            ...
            <div class="col-md-4">
                ...
                <asp:DropDownList ID="TutionTypeDropDownList" CssClass="form-control mb-3" runat="server">
                    <asp:ListItem>Select Tution Type</asp:ListItem>
                    <asp:ListItem>Online</asp:ListItem>
                    <asp:ListItem>Offline</asp:ListItem>
                </asp:DropDownList>
                                <asp:RequiredFieldValidator  InitialValue="Select Tution Type" ControlToValidate="TutionTypeDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator12" runat="server" ErrorMessage="TutionType  is Required"></asp:RequiredFieldValidator>

                <asp:DropDownList ID="TutorPreferredDropDownList" CssClass="form-control mb-3" runat="server">
                 ...
                 <asp:RequiredFieldValidator   InitialValue="Select Tutor Preferred" ControlToValidate="TutorPreferredDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator13" runat="server" ErrorMessage="TutionPreffered is Required"></asp:RequiredFieldValidator>
