...
namespace TMS_Project
{
    public partial class Contact : System.Web.UI.Page
    {
        ...
        protected void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            "Swal.fire('Success','Form Has Submitted successfully','success');", true); 
                Response.Write("<script>Swal.fire('Success','Message Sent!','success')</script>");
                ResetContact();
            }
            else
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "popup",
                  "Swal.fire('Failed','Form Insertion Failed','Error');", true);
            }
            con.Close();
        }
    }
